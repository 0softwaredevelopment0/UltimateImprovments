...
/**
 * EnchantmentSyncListener — keeps the Blunting PDC mirror
 * ({@code ui:blunting_level}) in sync with the real datapack enchantment.
 * <p>
 * Same failsafe backbone as all other charms: pickup / click / drag / join /
 * periodic scan; grindstone result clears the mirror so a legitimate
 * disenchantment isn't undone.
 */

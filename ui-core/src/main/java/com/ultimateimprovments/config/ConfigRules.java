...
final class ConfigRules {
    ...
    static final List<Rule> ALL = List.of(
            ...
            integer("reactor.temp_decay_divisor", 1, 100000000),
            ...
            integer("reactor.heat_rate", 0, 1000000),
            integer("reactor.cool_rate", 0, 1000000),
            ...
            integer("reactor.case_temp_max", 1, 100000),
            integer("reactor.shell_integrity_decay_temp", 0, 2000000000),
            integer("reactor.shell_int_decay_rate", 0, 1000),
            integer("reactor.shell_int_recovery_temp_max", 0, 2000000000),
            ...
            integer("reactor.recipe_temp_min", 0, 2000000000),
            integer("reactor.recipe_temp_max", 0, 2000000000),

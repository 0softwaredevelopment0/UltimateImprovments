...
final class ConfigRules {
    ...
    static final List<Rule> ALL = List.of(
            ...
            dbl("reactor.press_follow_rate", 0.0, 1.0),
            dbl("reactor.spin_follow_rate", 0.0, 1.0),
            integer("reactor.energy_rate", 0, 1000000),
            dbl("reactor.laser_ramp_rate", 0.0, 100.0),
            integer("reactor.power_laser_heat_rate", 0, 2000000000),
            integer("reactor.stab_cool_rate", 0, 2000000000),
            dbl("reactor.shield_build_rate", 0.0, 100.0),
            dbl("reactor.shield_stress_heat_per", 1.0, 2000000000.0),
            dbl("reactor.shield_stress_press_per", 0.01, 1000.0),
            dbl("reactor.shield_stress_spin_per", 1.0, 10000000.0),
            dbl("reactor.shield_decay_base", 0.001, 100.0),
            integer("reactor.shield_recovery_every_sec", 1, 3600),
            dbl("reactor.shield_recovery_rate", 0.0, 100.0),
            ...
            dbl("reactor.selfdestruct_chance", 0.0, 100.0),
            integer("reactor.selfdestruct_no_signal_sec", 0, 3600),
            integer("reactor.selfdestruct_timed_sec", 1, 3600),
            dbl("reactor.selfdestruct_overpower_rate", 0.1, 100.0),
            dbl("reactor.selfdestruct_adv_radius", 1.0, 200.0),
            dbl("reactor.absorber_cool_rate", 0.0, 2000000000.0),
            dbl("reactor.absorber_rad_per_sec", 0.0, 100000.0),
            ...
            dbl("reactor.fuel_work_spin", 1.0, 10000000.0),
            dbl("reactor.fuel_over_spin", 1.0, 10000000.0),
            dbl("reactor.fuel_base_rate", 0.0, 100.0),
            dbl("reactor.fuel_min_rate", 0.0, 100.0),
            dbl("reactor.fuel_over_per_10k", 0.0, 100.0),
            dbl("reactor.fuel_no_fuel_spin_decay", 0.0, 100000.0),
            integer("reactor.fusion_temp_min", 0, 2000000000),
            integer("reactor.fusion_temp_work", 1, 2000000000),
            integer("reactor.fusion_temp_peak", 1, 2000000000),
            integer("reactor.fusion_temp_end", 1, 2000000000),
            integer("reactor.fusion_particles_per_sec", 0, 10000),
            dbl("reactor.fusion_absorb_rate", 0.0, 10000.0),
            integer("reactor.fusion_debris_per", 1, 1000000000),
            integer("reactor.case_heat_rate", 0, 100000),
            integer("reactor.case_temp_max", 1, 100000),
            integer("reactor.case_temp_min", -10000, 0),
            dbl("reactor.case_press_max", 0.0, 1000.0),
            dbl("reactor.case_press_follow_rate", 0.0, 1.0),
            integer("reactor.case_int_decay_temp", 0, 100000),
            dbl("reactor.case_int_decay_press", 0.0, 1000.0),
            dbl("reactor.case_int_decay_rate", 0.0, 100.0),
            integer("reactor.meltdown_explosion_radius", 0, 500, "Reactor detonation explosion radius"),
